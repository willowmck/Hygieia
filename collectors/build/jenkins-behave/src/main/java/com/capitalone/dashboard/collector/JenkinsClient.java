...
public interface JenkinsClient {
     ...
     * @return boolean
     */
    boolean buildHasBehaveResults(String buildUrl, String instanceUrl);

    /**
     * This method is responsible for going to the Jenkins systems, accessing a specific build, getting the
     * (behave) results.json file, and parsing it to a TestResult
     *
     * @param buildUrl url of the Jenkins build
     * @return a TestResult
     */
    TestResult getBehaveTestResult(String buildUrl, String instanceUrl);

    Build getLastSuccessfulBuild (String buildUrl, String instanceUrl);
}
