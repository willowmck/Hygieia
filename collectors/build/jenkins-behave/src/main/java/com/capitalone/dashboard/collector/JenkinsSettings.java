 ...
 */
@Component
@ConfigurationProperties(prefix = "jenkins-behave")
public class JenkinsSettings {
    
    private String cron;
    private List<String> servers;
    private String behaveJsonRegex = "behave.json";
    ...
    public String getBehaveJsonRegex() {
        return behaveJsonRegex;
    }

    public void setBehaveJsonRegex(String behaveJsonRegex) {
        this.behaveJsonRegex = behaveJsonRegex;
    }
